...
void convert_chars(uint8_t *data, uint8_t len)
{
    ...
    for (i = 0; i < len; i++) {
        switch (data[i]) {
            ...
            /* block/half-block graphics via ATASCII codes */
            case 'a':  data[i] = 25;       break;  /* >▌< */
            case 'b':  data[i] = 25 + 128; break;  /* >▐< inverted */
            case 'c':  data[i] = 21;       break;  /* >▄< */
            case 'd':  data[i] = 21 + 128; break;  /* >▀< inverted */
            case 'e':  data[i] = 15;       break;  /* >▖< */
            case 'f':  data[i] = 9;        break;  /* >▗< */
            case 'g':  data[i] = 12;       break;  /* >▘< */
            case 'h':  data[i] = 11;       break;  /* >▝< */
            case 'i':  data[i] = 15 + 128; break;  /* >▜< inverted */
            case 'j':  data[i] = 9  + 128; break;  /* >▛< inverted */
            case 'k':  data[i] = 12 + 128; break;  /* >▟< inverted */
            case 'l':  data[i] = 11 + 128; break;  /* >▙< inverted */
